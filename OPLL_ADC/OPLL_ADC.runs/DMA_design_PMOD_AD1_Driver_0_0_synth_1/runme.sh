...
HD_PWD='D:/NextLab/Vivado/OPLL_ADC/OPLL_ADC/OPLL_ADC.runs/DMA_design_PMOD_AD1_Driver_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_design_PMOD_AD1_Driver_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_design_PMOD_AD1_Driver_0_0.tcl
