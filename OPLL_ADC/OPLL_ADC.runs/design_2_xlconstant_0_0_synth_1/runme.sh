...
HD_PWD='D:/NextLab/Vivado/OPLL_ADC/OPLL_ADC/OPLL_ADC.runs/design_2_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_xlconstant_0_0.tcl
