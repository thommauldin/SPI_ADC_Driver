...
proc create_root_design { parentCell } {
  ...
  # Create instance: PMOD_AD1_Driver_0, and set properties
  set PMOD_AD1_Driver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PMOD_AD1_Driver:2.1 PMOD_AD1_Driver_0 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXIS_TDATA_WIDTH {32} \
   CONFIG.NUMBER_OF_OUTPUT_WORDS {16} \
 ] $PMOD_AD1_Driver_0
  ...
  connect_bd_intf_net -intf_net PMOD_AD1_Driver_0_M00_AXIS [get_bd_intf_pins PMOD_AD1_Driver_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_net -net Net [get_bd_pins PMOD_AD1_Driver_0/m00_axis_tready] [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins ila_0/probe4]
  connect_bd_net -net PMOD_AD1_Driver_0_cs [get_bd_ports cs] [get_bd_pins PMOD_AD1_Driver_0/cs]
  connect_bd_net -net PMOD_AD1_Driver_0_m00_axis_tdata [get_bd_pins PMOD_AD1_Driver_0/m00_axis_tdata] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins ila_0/probe0]
  connect_bd_net -net PMOD_AD1_Driver_0_m00_axis_tlast [get_bd_pins PMOD_AD1_Driver_0/m00_axis_tlast] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast] [get_bd_pins ila_0/probe9]
  connect_bd_net -net PMOD_AD1_Driver_0_m00_axis_tvalid [get_bd_pins PMOD_AD1_Driver_0/m00_axis_tvalid] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins ila_0/probe3]
  connect_bd_net -net PMOD_AD1_Driver_0_sclk [get_bd_ports sclk] [get_bd_pins PMOD_AD1_Driver_0/sclk] [get_bd_pins ila_0/probe2]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins ila_0/probe5]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tkeep [get_bd_pins axi_dma_0/m_axis_mm2s_tkeep] [get_bd_pins ila_0/probe8]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] [get_bd_pins ila_0/probe7]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins ila_0/probe6]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins PMOD_AD1_Driver_0/Enable] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net miso_1 [get_bd_ports miso] [get_bd_pins PMOD_AD1_Driver_0/miso] [get_bd_pins ila_0/probe1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PMOD_AD1_Driver_0/m00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PMOD_AD1_Driver_0/m00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_dma_0/m_axis_mm2s_tready] [get_bd_pins xlconstant_1/dout]
